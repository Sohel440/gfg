<h2><a href="https://www.geeksforgeeks.org/problems/jump-game/1?page=5&category=Dynamic%20Programming,Recursion,Backtracking&sortBy=submissions">Jump Game</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an positive integer N and a list of N integers A[]. Each element in the array denotes the maximum length of jump you can cover. Find out if you can make it to the last index if you start at the first index of the list.</span></p>
