...
void kaj_kori() {
      string sohel;
        cin >> sohel;
int hh = stoi(sohel.substr(0, 2));
    int mm = stoi(sohel.substr(3, 2));

    if (hh == 0) {
        cout << "12:" << setw(2) << setfill('0') << mm << " AM" << endl;
    } else if (hh < 12) {
        cout << setw(2) << setfill('0') << hh << ":" << setw(2) << setfill('0') << mm << " AM" << endl;
    } else if (hh == 12) {
        cout << "12:" << setw(2) << setfill('0') << mm << " PM" << endl;
    } else {
        cout << setw(2) << setfill('0') << hh - 12 << ":" << setw(2) << setfill('0') << mm << " PM" << endl;;
    }
}
