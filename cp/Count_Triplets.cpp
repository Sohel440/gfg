   ...
   int n;
       ...
       for(int i=1;i<=n;i++)
       {
           for(int j=0;j<=99 && i+j<=n;j++)
           {
               ...
               {
                   int mid1=(i+index-diff)/2;
                   int mid2=(i+index+diff)/2;
           ...
           for(int j=1;j<=99 && i-j>=1;j++)
           {
               ...
               else if(dis>j && (dis-j) %2==0)
               {
                   int m1=(i+ind-dis)/2;
                   int m2=(i+ind+dis)/2;
 
                   if((i+ind-dis)%2==0 && m1>=1 && m1<=n)
                   {
                       sohel+=1;
                   }
 
                   if((i+ind+dis)%2==0 && m2>=1 && m2<=n)
                   {
                       sohel+=1;
                   }
               }
