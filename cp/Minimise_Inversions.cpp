...
int merge(string&arr, int low, int mid, int high) {
...
int mergeSort(string&arr, int low, int high) {
    int cnt = 0;
...
int numberOfInversions(string&a, int n) {
