...
vector<char> printSpiral(vector<vector<char>> &mat) {
...
void kaj() {
   ...
   for(auto tt: arr){
      ...
      if(temp[temp.size() - 3] == '1' && temp[temp.size() - 2] == '5' && temp[temp.size() - 1] == '4'&&temp[0] == '3')cnt++;
      if(temp[temp.size() - 2] == '1' && temp[temp.size() - 1] == '5' && temp[0] == '4'&&temp[1] == '3')cnt++;
      if(temp[temp.size() - 1] == '1' && temp[0] == '5' && temp[1] == '4'&&temp[2] == '3')cnt++;

      for(int i = 0 ; i < temp.size(); i++){
         if(temp[i] == '1'  && i < temp.size()-4){
            if(target [1] == temp[i+1] && target[2] == temp[i+2] && target[3] == temp[i+3]){
                cnt++;
            }
         }
      }
