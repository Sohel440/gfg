...
void kaj() {
     ...
     fore(i , 0 , n+2) // why n+2 ,? because if all the element is present twice  it will be help to find the smallest firs number
     {
        if(mp[i] == 0){
            last = i;
            break;
     ...
     if(b.size() == 0 || b.size()==1){
        cout << last << endl; /// 0 0  1 1 here 2 is mex for that above we take n+2 
        // and same case for the 0 0 1 2 2 here 3 mex and still b is non empty 
     }
     else{
        cout << b[1]<< endl;
     }
