...
// Function to find the resulting string that gives maximum typing time after inserting one character
string max_typing_time_string(const string& s) {
...
void kaj() {  
   ...
   int n; cin >> n;
    vector <vector <char>> sohel(2 , vector <char>(n));
    for(auto &x : sohel){
  ...
  forn(i , 0,2){
        forn(j, 0 , n){
            if(sohel[i][j] == '.'){
                ...
                if(i == 0){
                    if(sohel[i + 1][j] == '.' && ( j-i >=0 && sohel[i][j - 1] == '.')&& (j+1 < n && sohel[i][j + 1] == '.')){
                        if((j - 1 >= 0 && sohel[i + 1][j - 1] == 'x' ) && (j + 1 < n && sohel[i + 1][j + 1] == 'x' )){
                            bal++;
                        }
                    }
                }
                    ...
                    if(sohel[i - 1][j] == '.'){
                        if((j - 1 >= 0 && sohel[i - 1][j - 1] == 'x' && sohel[i][j - 1] == '.') && (j + 1 < n && sohel[i - 1][j + 1] == 'x' && sohel[i][j + 1] == '.')){
                            bal++;
                        } 
                    }
                }
